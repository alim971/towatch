...
<div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
        <div class="mt-8 bg-white dark:bg-gray-800 dark:text-white overflow-hidden shadow sm:rounded-lg">
            <div class="grid grid-cols-1" style="text-align: center">
                <form action="{{ route('movies.update', $movie) }}" class="form-horizontal" method="post">
                    ...
                    <div class="row" style="min-width: 500px">
                        <div class="col-md-12">
                            ...
                            <div class="x_panel" style="margin-right: 30px">
                                <div class="x_title">
                                    <h2>Edit movie</h2>
                                    ...
                                    <div class="">
                                        ...
                                        <div class="">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="name" required name="name" value="{{old('name', $movie->name)}}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="name" class="col-sm-4 control-label">Description</label>
                                                <div class="col-sm-8">
                                                    <input type="text" min="1" class="form-control" id="description" name="description" value="{{old('description', $movie->description)}}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="url" name="url"
                                                           value="{{old('url', $movie->url)}}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="imdb" class="col-sm-4 control-label">IMDB/CSFD</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="imdb" name="imdb"
                                                           value="{{old('imdb', $movie->imdb)}}">
                                                </div>
                                            </div>
                                            <div class="col-sm-8">
                                                <label for="watched" class="col-sm-4 control-label">Watched:</label>
                                                <input type="hidden" name="watched" value="0">
                                                <input type="checkbox" {{$movie->watched ? "checked" : ""}} data-switchery="true" class="js-switch" name="watched"
                                                       value="1">
                                            </div>
