    ...
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
        <div class="mt-8 bg-white dark:bg-gray-800 dark:text-white overflow-hidden shadow sm:rounded-lg">
            <div class="grid grid-cols-1" style="text-align: center">
                <form action="{{ route('movies.store') }}" class="form-horizontal" method="post">
                    @csrf
                                    ...
                                    <div class="">
                                        ...
                                        <div class="">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" min="1" class="form-control" id="description" name="description" value="{{old('description')}}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <input type="checkbox" class="js-switch" name="watched"
                                                       value="1">
                                            </div>
